...
describe('olderCards', () => {
  ...
  it('pins the index newest, not the listing row, when they differ', () => {
    // Inbox row id 10 is the other side's last inbox mail; 99 is the reply
    // in Sent. Passing 10 here is the #19 bug: the Sent message leaves the
    // pin and the inbox mail stays on screen as "newest".
